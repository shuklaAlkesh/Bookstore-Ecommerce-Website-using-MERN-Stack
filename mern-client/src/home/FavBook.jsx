  ...
  return (
    <div className='px-4 lg:px-4 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        <div className='md:w-1/2'>
            <img src={FavBookIMG} alt="" className='px-18 py-18'/>
        </div>
        <div className='md:w-1/2 space-y-6'>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae sapiente, dolorem iusto quaerat autem officiis numquam, soluta velit vitae architecto molestias iure, similique inventore et illo tempore maxime consectetur quod!</p>
             {/* stats */}
            <div className='flex flex-col sm:flex-row justify-between gap-12 md:w-3/4 my-14'>
                <div>
